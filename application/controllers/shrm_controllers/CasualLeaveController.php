...
class CasualLeaveController extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('shrm_models/CasualLeave', 'CasualLeave');
    }
    ...
    public function index()
    {
        ...
        $data['users'] = $this->User->get_users_with_latest_contract(); // You'll need to implement this

        $this->load->view('shrm_views/pages/casual_leave/index', $data);
    }
