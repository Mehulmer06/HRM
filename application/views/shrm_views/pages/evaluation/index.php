                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="category-badge"
                                              style="background: <?= $categoryBadge[0] ?>; color: <?= $categoryBadge[1] ?>; padding: 4px 8px; border-radius: 12px; font-size: 12px; font-weight: 500;">
    ...
    $(document).ready(function () {
        ...
        document.querySelectorAll('[data-bs-toggle="tab"]').forEach(tab => {
            tab.addEventListener('shown.bs.tab', () => {
                setTimeout(() => $.fn.dataTable.tables({
                    visible: true,
                    api: true
                }).columns.adjust(), 100);
            });
