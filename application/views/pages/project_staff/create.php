    ...
    <div class="form-card">
        ...
        <div class="row form-row">
            <div class="col-md-6">
                ...
                <input type="tel" class="form-control" id="mobile" name="mobile" required placeholder="+91 XXXXX XXXXX">
            </div>
            <div class="col-md-6">
                <label for="pan" class="form-label">PAN Number *</label>
                <input type="text" class="form-control" id="pan" name="pan" required placeholder="ABCDE1234F"
    ...
    <div class="form-card">
        ...
        <div class="row form-row">
            <div class="col-md-6">
                ...
                <select class="form-select select2" id="reporting_officer" name="reporting_officer" required>
    ...
    <div class="form-card">
        ...
        <div class="row form-row">
            ...
            <div class="col-md-6">
                ...
                <input type="file" id="signature" name="signature" class="file-upload-input" accept="image/*" required>
    ...
    <div class="form-card">
        ...
        <div class="row form-row">
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="designation" name="designation" required
                       placeholder="Initial designation">
            </div>
            <div class="col-md-6">
        ...
        <div class="row form-row">
            <div class="col-md-4">
                ...
                <input type="number" class="form-control" id="contract_months" name="contract_months" required
            ...
            <div class="col-md-4">
                ...
                <input type="number" class="form-control" id="salary" name="salary" required
                       placeholder="Enter amount in INR" min="0" step="0.01">
            </div>
        </div>
        ...
        <div class="row form-row">
            <div class="col-md-6">
                ...
                <select class="form-select select2" id="project_name" name="project_name" required>
                    <option value="">Select Project</option>
                    <option value="website_redesign">Website Redesign Project</option>
                    <option value="mobile_app">Mobile App Development</option>
                    <option value="erp_system">ERP System Implementation</option>
                    <option value="data_migration">Data Migration Project</option>
                    <option value="security_audit">Security Audit Project</option>
                </select>
            </div>
        </div>
    </div>
